 ...
 */
package org.deepinthink.magoko.config.client.condition;

import static org.deepinthink.magoko.config.client.ConfigClientConstants.PREFIX;
...
class OnConfigClientLaunchModeCondition extends SpringBootCondition {
  @Override
  public ConditionOutcome getMatchOutcome(
      ConditionContext context, AnnotatedTypeMetadata metadata) {
    Map<String, Object> attributes =
        Objects.requireNonNull(
            metadata.getAnnotationAttributes(ConditionalOnConfigClientLaunchMode.class.getName()));
  ...
  private ConditionOutcome getMatchOutcome(
    ...
    ConditionMessage.Builder builder =
        ConditionMessage.forCondition(ConditionalOnConfigClientLaunchMode.class);
    try {
