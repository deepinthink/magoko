...
class OnArchiveClientLaunchModeCondition extends SpringBootCondition {
  ...
  public ConditionOutcome getMatchOutcome(
    ...
    Map<String, Object> attributes =
        Objects.requireNonNull(
            metadata.getAnnotationAttributes(ConditionalOnArchiveClientLaunchMode.class.getName()));
  ...
  private ConditionOutcome getMatchOutcome(
    ...
    ConditionMessage.Builder builder =
        ConditionMessage.forCondition(ConditionalOnArchiveClientLaunchMode.class);
    try {
