...
public class NettyMSocketWsServerTransport implements NettyMSocketServerTransport {
  ...
  NettyMSocketWsServerTransport(HttpServer httpServer, String mappingPath) {
  ...
  public static BiFunction<WebsocketInbound, WebsocketOutbound, Publisher<Void>> newHandler(
    ...
    return (wsInbound, wsOutBound) ->
        acceptor
            .apply(new NettyMSocketWsConnection((Connection) wsInbound))
