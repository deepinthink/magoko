...
public final class BootstrapConstants {
  ...
  public static final int DEFAULT_BOOTSTRAP_CONFIG_ENV_POST_PROCESSOR_ORDER =
      Integer.getInteger(PREFIX + ".config-env-order", Ordered.HIGHEST_PRECEDENCE);

  public static final String DEFAULT_BOOTSTRAP_CONFIG_FILE =
      System.getProperty(PREFIX + ".config-file", "bootstrap.properties");
