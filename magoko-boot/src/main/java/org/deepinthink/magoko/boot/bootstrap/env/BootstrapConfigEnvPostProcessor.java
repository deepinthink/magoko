...
public class BootstrapConfigEnvPostProcessor implements EnvironmentPostProcessor, Ordered {

  private final Log logger;

  public BootstrapConfigEnvPostProcessor(DeferredLogFactory logFactory) {
    logger = logFactory.getLog(getClass());
  }

  @Override
  public int getOrder() {
    return DEFAULT_BOOTSTRAP_CONFIG_ENV_POST_PROCESSOR_ORDER;
  }
        ...
        if (!properties.isEmpty()) {
          PropertiesPropertySource pps =
              new PropertiesPropertySource(
                  DEFAULT_BOOTSTRAP_CONFIG_PROPERTY_SOURCE_NAME, properties);
